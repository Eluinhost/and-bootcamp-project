  ...
  render() {
    return (
      <div className="pt-card">
        ...
        <div className="user-nationality">Nationality: {this.props.user.nationality}</div>
        <div className="user-age">Age: <YearsFromNow time={this.props.user.dob}/> years old</div>
      </div>
    )
  }
}
